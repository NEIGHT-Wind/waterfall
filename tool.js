	...
	function drag (elem) {
	    elem.onmousedown = function (e) {
	    	...
	    	document.onmousemove = function (e) {
	        	var event = e || window.event;
	            elem.style.top = event.clientY - elemY + 'px';
	            elem.style.left = event.clientX - elemX + 'px';
	        };
	    };
...
// Ajax
	function Ajax(method, url, boolen, data, callBack) {
		var ajax = null;
		...
		if (method == 'GET') {
			ajax.open(method, url + '?' + data, boolen);
			ajax.send();
		}else if (method == 'POST') {
			ajax.open(method, url, boolen);
